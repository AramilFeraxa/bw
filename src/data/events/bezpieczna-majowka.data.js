const bezpiecznaMajowka2024 = {
    seoTitle: "Bezpieczna majówka – konsultanci Stowarzyszenia ostrzegają przed ryzykiem wyjazdów z noclegiem",
    seoDescription:
        "Konsultanci Stowarzyszenia Aktywni na Rzecz Bezpiecznego Wypoczynku zapraszają do Zamku Czocha (1–3 maja 2024) na rozmowy o bezpieczeństwie dzieci podczas wycieczek i kolonii z noclegiem.",
    title: "Bezpieczna majówka – konsultanci Stowarzyszenia ostrzegają przed ryzykiem wyjazdów z noclegiem",
    dateBadge: "01.05.2024",
    date: "01.05.2024",
    endDate: "03.05.2024",
    ...
    intro: [
        "Długi weekend majowy to dla wielu szkół i rodzin generalna próba przed letnimi koloniami. Właśnie wtedy – 1–3 maja, od 10.00 do 18.00 – nasi specjaliści z Aktywnych na Rzecz Bezpiecznego Wypoczynku czekają w Zamku Czocha w punkcie oznaczonym logo Bezpiecznywypoczynek.pl.",
        "Tym razem nie tylko podpowiadamy, jak wybrać organizatora, lecz przede wszystkim omawiamy realne zagrożenia, które towarzyszą dzieciom podczas wycieczek i kolonii z noclegiem poza domem.",
    ],
    ...
    sections: [
        ...
        },
        {
            ...
            paragraphs: [
                "Setki tysięcy uczniów ruszą latem na wyjazdy pod nadzorem nauczycieli i wychowawców. Świetna przygoda nie wyklucza ryzyka.",
                "Rozmowa z naszym konsultantem pomoże Ci przygotować pytania do organizatora, wyposażyć dziecko w praktyczne zasady bezpieczeństwa i spokojniej zapakować walizkę.",
                "Zapraszamy do Zamku Czocha – porozmawiajmy o zagrożeniach, zanim majowe słońce zamieni się w lipcową burzę. Bezpieczne wakacje zaczynają się od świadomych decyzji!",
            ],
        },
    ],
...
export default bezpiecznaMajowka2024;
